...
public class MVCModelo2 {
	...
	public double tiempoPromedioDeViajeYDesviacionEstandarDeUnMes(int pMes,int pOrigen, int pDestino)
	{
	int cont = 0;
	int total = 0;
	double promedio = 0;
	...
	while(iter.haySiguiente())
	{
		...
		if( actual.darIndicadorTemporal() == pMes &&  actual.darIdOrigen() > pOrigen && actual.darIdDestino() < pDestino)
		{
	...
	public boolean estaEnElRango(int n, int a, int b)
	{
		boolean rta = false;
		if(n >= a && n<= b)
	{
